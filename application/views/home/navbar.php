<header style="margin-top: 0px; background-color:rgb(209, 20, 20); " class="new-block main-header home2">
	...
	<div class="top-nav new-block">
		<div class="container">
			<div class="nav-wrapper">
				...
				<div class="logo">
					<a href="<?= base_url('home') ?>"><img src="<?= base_url(); ?>assets/images/logos2.png" alt="logo" class="img-responsive"></a>
				</div>
			</div>
		</div>
	</div>
